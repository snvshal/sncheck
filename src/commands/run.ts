...
export async function runCommand(taskNames?: string[], options?: { parallel?: boolean; continue?: boolean }): Promise<void> {
  ...
  const result = await runTasks(tasksToRun, { parallel, continue: continueOnError });
